...
export class ConceptPageComponent implements AfterViewInit {
  ...
  researches: { name: string; href: string }[] = [
    {
      name: 'Общая характеристика проведённых исследований',
      href: '/assets/concept/Общая характеристика проведённых исследований.pdf',
    },
    {
      name: 'Историческая записка',
      href: '/assets/concept/Историческая записка.pdf',
    },
    {
      name: 'Отчёт по результатам социологического исследования',
      href: '/assets/concept/Отчет по результатам социологического исследования.pdf',
    },
    {
      name: 'Эколого-географическая характеристика территории села и его окружения',
      href: '/assets/concept/Эколого-географическая характеристика территории села и его окружения.pdf',
    },
    {
      name: 'Отчёт о текущем социально-экономическом положении села',
      href: '/assets/concept/Отчёт о текущем социально-экономическом положении села.pdf',
    },
    {
      name: 'Альбом фотофиксации',
      href: '/assets/concept/Альбом фотофиксации.pdf',
    },
    {
      name: 'Отчёт по результатам градостроительного обследования',
      href: '/assets/concept/Отчёт по результатам градостроительного обследования.pdf',
    },
  ];
